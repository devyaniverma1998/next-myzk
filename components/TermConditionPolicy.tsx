    ...
    <>
      <Container maxWidth="lg" sx={{ paddingY: 5 }}>
        ...
        >
          ...
          <Typography>
            This website is operated by Myzk. Throughout the site, the terms we,
            us and our refer to Myzk Store. Myzk Store offers this website,
          ...
          <Typography>
            ...
            conditions Terms of Service, including those additional terms and
            conditions and policies referenced here. These Terms of Service apply to all users of the site,
        ...
        >
          <Typography variant="h6">ONLINE STORE TERMS</Typography>
        ...
        >
          <Typography variant="h6">GENERAL CONDITIONS</Typography>
          <Typography paragraph>
        ...
        >
          ...
          <Typography paragraph>
            ...
            cannot guarantee that your computer monitors display of any color
            will be accurate.
          </Typography>
          <Typography paragraph>
        ...
        >
          <Typography variant="h6">A OPTIONAL TOOLS</Typography>
          <Typography paragraph>
        ...
        >
          ...
          <Typography paragraph>
            ...
            Please review carefully the third-partys policies and practices and
        ...
        >
          ...
          <Typography paragraph>
            ...
            otherwise objectionable or violates any partys intellectual
...
>
  ...
  <List>
    <ListItem>(a) for any unlawful purpose;</ListItem>
    <ListItem>(b) to solicit others to perform or participate in any unlawful acts;</ListItem>
    <ListItem>(c) to violate any international, federal, provincial or state regulations, rules, laws, or local ordinances;</ListItem>
    <ListItem>(d) to infringe upon or violate our intellectual property rights or the intellectual property rights of others;</ListItem>
    <ListItem>(e) to harass, abuse, insult, harm, defame, slander, disparage, intimidate, or discriminate based on gender, sexual orientation, religion, ethnicity, race, age, national origin, or disability;</ListItem>
    <ListItem>(f) to submit false or misleading information;</ListItem>
    <ListItem>(g) to upload or transmit viruses or any other type of malicious code that will or may be used in any way that will affect the functionality or operation of the Service or of any related website, other websites, or the Internet;</ListItem>
    <ListItem>(h) to collect or track the personal information of others;</ListItem>
    <ListItem>(i) to spam, phish, pharm, pretext, spider, crawl, or scrape;</ListItem>
    <ListItem>(j) for any obscene or immoral purpose;</ListItem>
    <ListItem>(k) to interfere with or circumvent the security features of the Service or any related website, other websites, or the Internet.</ListItem>
  </List>
  <Typography paragraph>
    We reserve the right to terminate your use of the Service or any related website for violating any of the prohibited uses.
        ...
        >
          ...
          <Typography paragraph>
            In no case shall Florencia Store, our directors, officers,
        ...
        >
          ...
          <Typography paragraph>
            You agree to indemnify, defend and hold harmless Florencia Store and
        ...
        >
          <Typography variant="h6">CHANGES TO TERMS OF SERVICE</Typography>
          <Typography paragraph>
        ...
        >
          ...
          <Typography paragraph>
            Our contact information is posted below: +91 8588862126{" "}
          </Typography>
          <Typography paragraph>
            If you need to exchange an item for a different size or color,
            please contact us within 7 days of receiving your order. You will be
            responsible for any price difference and any shipping costs
            associated with the exchange.{" "}
          </Typography>
          <Typography paragraph>
            Damaged or Defective Items In the rare event that your item arrives
            damaged or defective, please contact us immediately with photos of
            the damage or defect. We will arrange for a replacement or refund as
            soon as possible.{" "}
          </Typography>
        </Box>
      </Container>
